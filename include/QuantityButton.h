...
#ifndef __QNTY_BUTTON__
#define __QNTY_BUTTON__
...
class QuantityButton :
		public AuraButton,
		public std::enable_shared_from_this<QuantityButton> {
...
public:
	QuantityButton(std::shared_ptr<DBInterface> hDB) : AuraButton(hDB) { m_MsgToUser = "Choose quantity";}
